...
<div className="flex flex-col md:flex-row md:items-center md:justify-between border-b pb-2 gap-4">
  ...
  <div className="relative w-full md:w-1/3 mt-2 md:mt-0">
    ...
    <Search className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 w-4 h-4" />
        ...
        <div className="space-y-1">
          ...
          <Select value={course} onValueChange={setCourse}>
            ...
            <SelectContent>
              ...
              <SelectItem value="fullstack web application">Fullstack Web Application</SelectItem>
        ...
        <div className="space-y-1">
          ...
          <Select value={phase} onValueChange={setPhase}>
            ...
            <SelectContent>
              ...
              <SelectItem value="no phase 1 access">No Phase 1 Access</SelectItem>
              <SelectItem value="no phase 2 access">No Phase 2 Access</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      {/* Total Students */}
      <div className="text-sm text-gray-600">Total Students: {totalStudents}</div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm border-collapse border border-gray-300">
          <thead className="bg-gray-100 text-gray-700">
            <tr>
              <th className="text-left p-3 border-b border-gray-300">Avatar / Name</th>
